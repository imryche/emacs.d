...
(autothemer-deftheme
 ...
 (
  ...
  ;; (font-lock-doc-face (:foreground nohl-green))
  ...
  ;; (font-lock-negation-char-face (:foreground nohl-green))
  ;; (font-lock-preprocessor-face (:foreground nohl-green))
  ;; (font-lock-regexp-grouping-backslash (:foreground nohl-yellow))
  ;; (font-lock-regexp-grouping-construct (:foreground nohl-green))
  ...
  (mode-line (:foreground nohl-bg :background nohl-fg :weight 'normal
  ...
  (mode-line-highlight (:foreground nohl-green :box nil :weight 'bold))

  (minibuffer-prompt (:foreground nohl-green))
  ...
  ;; search
  (match (:foreground nohl-green :background nohl-bg :inverse-video t))
  (isearch (:foreground nohl-fg :background nohl-bg :inverse-video t))
  (lazy-highlight (:foreground nohl-green :background nohl-bg :inverse-video t))
  ...
  ;; dired
  ;; (dired-header (:foreground nohl-green))
  (dired-directory (:foreground nohl-green))
  (dired-perm-write (:foreground nohl-fg))

  ;; which-key
  (which-key-key-face (:foreground nohl-green))
  ...
  ;; (ansi-color-blue (:foreground nohl-green :background nohl-green))
  ;; (ansi-color-magenta (:foreground nohl-green :background nohl-green))
  ...
  ;; (term-color-blue (:foreground nohl-green :background nohl-green))
  ;; (term-color-magenta (:foreground nohl-green :background nohl-green))
  ...
  (ediff-even-diff-A (:foreground nohl-green :background nohl-contrast-bg :extend t))
  (ediff-even-diff-Ancestor (:foreground nohl-green :background nohl-highlight))
  (ediff-even-diff-B (:foreground nohl-green :background nohl-contrast-bg :extend t))
  (ediff-even-diff-C (:foreground nohl-green :background nohl-contrast-bg :extend t))
  ...
  (erc-nick-default-face (:weight 'normal :foreground nohl-green))
  ...
  (erc-prompt-face (:foreground nohl-green))
  ...
  (eshell-ls-archive (:foreground nohl-green))
  (eshell-ls-backup (:foreground nohl-comment))
  (eshell-ls-clutter (:foreground nohl-orange :weight 'bold))
  (eshell-ls-directory :foreground nohl-green :weight 'bold)
  ...
  (eshell-ls-special (:foreground nohl-green :weight 'bold))
  ...
  (gnus-cite-1 (:foreground nohl-green))
  (gnus-cite-2 (:foreground nohl-green))
  (gnus-cite-3 (:foreground nohl-aqua))
  (gnus-cite-4 (:foreground nohl-yellow))
  (gnus-cite-5 (:foreground nohl-orange))
  (gnus-cite-6 (:foreground nohl-green))
  (gnus-cite-7 (:foreground nohl-green))
  ...
  (gnus-group-mail-1 (:foreground nohl-green :weight 'normal))
  (gnus-group-mail-1-empty (:inherit 'gnus-group-mail-1 :foreground nohl-comment))
  (gnus-group-mail-2 (:foreground nohl-green :weight 'normal))
  ...
  (gnus-group-mail-6 (:foreground nohl-green :weight 'normal))
  ...
  (gnus-group-news-1 (:foreground nohl-green :weight 'normal))
  (gnus-group-news-1-empty (:inherit 'gnus-group-news-1 :foreground nohl-comment))
  (gnus-group-news-2 (:foreground nohl-green :weight 'normal))
  ...
  (gnus-group-news-6 (:foreground nohl-green :weight 'normal))
  ...
  (gnus-server-offline (:foreground nohl-green :weight 'bold))
  ...
  (gnus-summary-normal-unread (:foreground nohl-green :weight 'normal))

  ;; grep (built-in)
  (grep-context-face (:foreground nohl-comment))
  (grep-error-face (:foreground nohl-red :weight 'bold :underline t))
  (grep-hit-face (:foreground nohl-green))
  (grep-match-face (:foreground nil :background nil :inherit 'match))

  ;; hi-lock (built-in)
  (hi-black-hb (:weight 'bold))
  (hi-blue (:foreground nohl-bg :background nohl-green))
  (hi-blue-b (:foreground nohl-green :weight 'bold))
  ...
  ;; IDO (built-in)
  (ido-subdir (:foreground nohl-green))
  ...
  (info-title-4 (:weight 'bold :foreground nohl-green))
  ...
  (message-header-name (:foreground nohl-green :background nil))
  (message-header-newsgroups (:foreground nohl-aqua :background nil :slant 'normal))
  (message-separator (:foreground nohl-green))
  ...
  (orderless-match-face-3 (:foreground nohl-green))

  ;; org-mode (built-in)
  (org-agenda-structure (:foreground nohl-green))
  (org-agenda-current-time (:foreground nohl-yellow))
  (org-agenda-date (:foreground nohl-green :underline nil))
  ...
  (org-date (:foreground nohl-green :underline t))
  ...
  (org-habit-clear-future-face (:foreground nohl-bg :background nohl-green))
  (org-habit-overdue-face (:foreground nohl-bg :background nohl-green))
  ...
  (org-link (:foreground nohl-green :underline t))
  ...
  (org-table (:foreground nohl-green))
  ...
  ;; Outline (built-in)
  (outline-1 (:inherit nil :foreground nohl-green))
  (outline-2 (:inherit nil :foreground nohl-green))
  ...
  (outline-6 (:inherit nil :foreground nohl-green))
  (outline-7 (:inherit nil :foreground nohl-green))
  ...
  (show-paren-match (:background nohl-green :foreground nohl-bg))
  (show-paren-match-expression (:background nohl-fg :foreground nohl-bg))
  ...
  (rcirc-other-nick (:foreground nohl-green))
  (rcirc-prompt (:foreground nohl-green))
  ...
  (reb-match-3 (:foreground nohl-bg :background nohl-green))
  ...
  (ruler-mode-tab-stop (:foreground nohl-green :background nohl-contrast-bg))
  ...
  (speedbar-separator-face (:foreground nohl-bg :background nohl-green :overline nohl-bg))
  (speedbar-tag-face (:foreground nohl-yellow))
  (vhdl-speedbar-architecture-face (:foreground nohl-green))
  (vhdl-speedbar-architecture-selected-face (:foreground nohl-green :underline t))
  ...
  (vhdl-speedbar-library-face (:foreground nohl-green))
  ...
  (which-func (:foreground nohl-green :background nil :weight 'bold))
  ...
  (anzu-match-3 (:foreground nohl-green))
  ...
  (font-latex-math-face (:foreground nohl-green))
  ...
  (font-latex-slide-title-face (:foreground nohl-green :weight 'bold :height 1.2))
  (font-latex-string-face (:inherit 'font-lock-string-face))
  (font-latex-verbatim-face (:inherit 'font-lock-string-face))
  (font-latex-warning-face (:inherit 'warning))
  ;; TeX-fold
  (TeX-fold-folded-face (:foreground nohl-green))
  ...
  (avy-lead-face-0 (:foreground nohl-bg :background nohl-green))
  ...
  (bm-persistent-face (:background nohl-green :foreground nohl-bg :extend t))
  ...
  (bmkp-bookmark-file (:foreground nohl-green :background nohl-contrast-bg))
  (bmkp-bookmark-list (:background nohl-contrast-bg))
  (bmkp-buffer (:foreground nohl-green))
  (bmkp-desktop (:foreground nohl-bg :background nohl-green))
  ...
  (bmkp-light-fringe-autonamed (:foreground nohl-contrast-bg :background nohl-green))
  ...
  (bmkp-sequence (:foreground nohl-green))
  (bmkp-su-or-sudo (:foreground nohl-red))
  (bmkp-t-mark (:foreground nohl-green))
  (bmkp-url (:foreground nohl-green :underline t))
  (bmkp-variable-list (:foreground nohl-green))

  ;; Caml
  (caml-types-def-face (:inherit 'highlight :box (:color nohl-green :line-width -1)))
  ...
  (caml-types-typed-face (:inherit 'highlight :box (:color nohl-green :line-width -1)))
  ...
  (circe-prompt-face (:foreground nohl-green))
  (circe-server-face (:foreground nohl-green))
  (circe-topic-diff-new-face (:foreground nohl-green))
  ...
  (clojure-special (:foreground nohl-green))
  (clojure-java-call (:foreground nohl-green))
  ...
  (coffee-mode-function-param (:foreground nohl-green))
  ...
  (company-preview-search (:inherit 'company-preview :foreground nohl-green))
  ...
  (company-tooltip-search (:inherit 'company-tooltip :foreground nohl-green))
  ...
  (counsel-css-selector-depth-face-5 (:foreground nohl-green))
  (counsel-css-selector-depth-face-6 (:foreground nohl-green))
  ...
  (diff-hl-change (:foreground nohl-bg :background nohl-green))
  ...
  ;; diredfl
  (diredfl-compressed-file-suffix (:foreground nohl-green))
  (diredfl-compressed-file-name (:foreground nohl-green))
  (diredfl-deletion (:inherit 'error :inverse-video t))
  (diredfl-deletion-file-name (:inherit 'error))
  (diredfl-date-time (:foreground nohl-green))
  ...
  (diredfl-link-priv (:background nil :foreground nohl-green))
  ...
  (elfeed-search-date-face (:foreground nohl-green))
  ...
  ;; EMMS
  (emms-browser-artist-face (:foreground nohl-green))
  (emms-browser-album-face (:foreground nohl-aqua))
  (emms-browser-track-face (:foreground nohl-yellow))
  (emms-browser-year/genre-face (:foreground nohl-green))
  ...
  (eyebrowse-mode-line-delimiters (:foreground nohl-green))
  (eyebrowse-mode-line-inactive (:foreground nohl-comment))
  (eyebrowse-mode-line-separator (:foreground nohl-green))
  ...
  (git-gutter:modified (:foreground nohl-green :weight 'bold))
  ...
  ;; git-timemachine
  (git-timemachine-minibuffer-author-face (:foreground nohl-green))
  (git-timemachine-minibuffer-detail-face (:foreground nohl-green))

  ;; guide-key
  (guide-key/prefix-command-face (:foreground nohl-green))
  ...
  (helm-bookmark-gnus (:foreground nohl-green))
  ...
  (helm-buffer-directory (:foreground nohl-green))
  ...
  (helm-ff-socket (:foreground nohl-green))
  (helm-ff-suid (:foreground nohl-bg :background nohl-red))
  (helm-grep-file (:foreground nohl-green :underline t))
  ...
  (helm-separator (:foreground nohl-green))
  ...
  (helm-visible-mark (:foreground nohl-green))
  ...
  (helm-ls-git-deleted-and-staged-face (:foreground nohl-green))
  ...
  (helm-ls-git-renamed-modified-face (:foreground nohl-green))
  ...
  (helm-rg-match-text-face (:foreground nohl-bg :background nohl-green))
  (helm-rg-preview-line-highlight (:foreground nohl-green))
  (helm-rg-title-face (:foreground nohl-green))

  ;; helm-switch-shell
  (helm-switch-shell-new-shell-face (:foreground nohl-bg :background nohl-green))
  ...
  ;; Hydra
  (hydra-face-blue (:foreground nohl-green))
  (hydra-face-teal (:foreground nohl-aqua))
  (hydra-face-pink (:foreground nohl-green))
  ...
  (info-constant-ref-item (:foreground nohl-green :background nohl-highlight))
  ...
  (info-syntax-class-item (:foreground nohl-green :background nohl-highlight))
  ...
  (info-xref-bookmarked (:foreground nohl-green))

  ;; Ivy
  (ivy-action (:foreground nohl-green))
  ...
  (ivy-subdir (:foreground nohl-green))
  ...
  (ivy-minibuffer-match-face-3 (:foreground nohl-green))
  ...
  (jabber-roster-user-chatty (:foreground nohl-green))
  ...
  (jabber-activity-face (:foreground nohl-green))
  (jabber-activity-personal-face (:foreground nohl-aqua))

  ;; Cperl
  (cperl-array-face (:foreground nohl-green :weight 'bold))
  (cperl-hash-face (:foreground nohl-red :slant 'italic))
  (cperl-nonoverridable-face (:foreground nohl-green))

  ;; js2-mode
  (js2-warning (:underline nohl-orange))
  (js2-error (:foreground nil :underline nohl-red))
  (js2-external-variable (:foreground nohl-green))
  (js2-function-param (:foreground nohl-green))
  (js2-instance-member (:foreground nohl-green))
  ...
  (js2-private-member (:foreground nohl-green))
  ...
  (js3-external-variable-face (:foreground nohl-green))
  (js3-function-param-face (:foreground nohl-green))
  ...
  (js3-jsdoc-html-tag-name-face (:foreground nohl-green))
  (js3-jsdoc-html-tag-delimiter-face (:foreground nohl-green))
  (js3-instance-member-face (:foreground nohl-green))
  ...
  (ledger-font-posting-account-cleared-face (:foreground nohl-green))
  (ledger-font-posting-account-face (:foreground nohl-green))
  ...
  (magit-branch-current (:foreground nohl-green))
  (magit-branch-local (:foreground nohl-aqua))
  (magit-branch-remote (:foreground nohl-green))
  (magit-cherry-equivalent (:foreground nohl-green))
  ...
  (magit-reflog-amend (:foreground nohl-green))
  (magit-reflog-checkout (:foreground nohl-green))
  ...
  (magit-reflog-rebase (:foreground nohl-green))
  ...
  (magit-sequence-head (:foreground nohl-green))
  ...
  (magit-signature-revoked (:foreground nohl-green))
  ...
  (markdown-link-face (:foreground nohl-green :underline t))
  (markdown-code-face (:inherit 'fixed-pitch :background nohl-bg :foreground nohl-green))
  (markdown-inline-code-face (:inherit 'markdown-code-face))

  ;; markup
  (markup-code-face (:inherit 'fixed-pitch :background nohl-bg :foreground nohl-green))
  (markup-complex-replacement-face (:background nohl-bg))
  (markup-error-face (:foreground nohl-red :background nohl-bg :weight 'bold))
  (markup-gen-face (:foreground nohl-green))
  ...
  (markup-title-0-face (:foreground nohl-green :weight 'bold :height 1.4))
  (markup-title-1-face (:foreground nohl-green :weight 'bold :height 1.2))
  (markup-title-2-face (:foreground nohl-orange :weight 'bold))
  (markup-title-3-face (:foreground nohl-green :weight 'bold))
  (markup-title-4-face (:foreground nohl-green :weight 'bold))
  (markup-title-5-face (:foreground nohl-green :weight 'bold))
  ...
  (mu4e-replied-face (:foreground nohl-green :inherit nil))
  (mu4e-unread-face (:foreground nohl-yellow :inherit nil))
  (mu4e-cited-1-face (:foreground nohl-green :slant 'normal))
  (mu4e-cited-2-face (:foreground nohl-green :slant 'normal))
  ...
  (mu4e-cited-6-face (:foreground nohl-green :slant 'normal))
  (mu4e-cited-7-face (:foreground nohl-green :slant 'normal))
  (mu4e-ok-face (:foreground nohl-green))
  (mu4e-view-contact-face (:inherit nil :foreground nohl-yellow))
  (mu4e-view-link-face (:inherit 'link :foreground nohl-green))
  ...
  ;; neotree
  (neo-banner-face (:foreground nohl-green :weight 'bold))
  ...
  (neo-vc-unlocked-changes-face (:foreground nohl-green :slant 'italic))
  (neo-vc-user-face (:foreground nohl-red :slant 'italic))

  ;; nswbuff
  (nswbuff-current-buffer-face (:foreground nohl-green :weight 'bold :underline nil))
  (nswbuff-default-face (:foreground nohl-fg :background nohl-bg))
  (nswbuff-separator-face (:foreground nohl-comment))
  (nswbuff-special-buffers-face (:foreground nohl-green :bold nil :underline nil))
  ...
  (powerline-evil-emacs-face (:inherit 'powerline-evil-base-face :background nohl-green))
  (powerline-evil-insert-face (:inherit 'powerline-evil-base-face :background nohl-green))
  ...
  (rainbow-delimiters-depth-5-face (:foreground nohl-green))
  ...
  (rpm-spec-tag-face (:foreground nohl-green))
  ...
  (slime-repl-prompt-face (:underline nil :weight 'bold :foreground nohl-green))
  (slime-repl-result-face (:foreground nohl-green))
  (slime-repl-output-face (:foreground nohl-green :background nohl-bg))
  (slime-repl-inputed-output-face (:foreground nohl-comment))

  ;; SLY
  (sly-error-face (:underline (:style 'wave :color nohl-red)))
  (sly-mrepl-output-face (:foreground nohl-green :background nohl-bg))
  ...
  (sly-stickers-armed-face (:foreground nohl-bg :background nohl-green))
  ...
  (syslog-info (:weight 'bold :foreground nohl-green))
  (syslog-su (:weight 'bold :foreground nohl-green))
  ...
  (twittering-uri-face (:foreground nohl-green :inherit 'link))
  ...
  (vr/group-0 (:foreground nohl-green :background nohl-bg :inverse-video t))
  ...
  ;; (vterm-color-blue (:background nohl-green :foreground nohl-green))
  ...
  ;; (vterm-color-magenta (:background nohl-green :foreground nohl-green))
  ...
  (wgrep-done-face (:foreground nohl-green))
  ...
  (cscope-function-face (:foreground nohl-green))
  (cscope-line-number-face (:foreground nohl-red))
  (cscope-separator-face (:bold t :overline t :underline t :foreground nohl-green))
